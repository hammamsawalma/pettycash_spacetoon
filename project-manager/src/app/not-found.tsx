    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-4" dir="rtl">
            <div className="text-center max-w-md w-full">
                ...
                {/* Message */}
                <h2 className="text-2xl font-bold text-white mb-3">{locale === 'ar' ? 'الصفحة غير موجودة' : 'Page Not Found'}</h2>
                <p className="text-slate-400 text-sm leading-relaxed mb-8">
                    {locale === 'ar' ? 'الصفحة التي تبحث عنها غير موجودة أو ربما تم نقلها.' : 'The page you are looking for does not exist or may have been moved.'}
                </p>
