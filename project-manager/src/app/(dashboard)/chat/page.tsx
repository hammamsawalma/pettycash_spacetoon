                    ...
                    <div className="flex-1 overflow-y-auto">
                        ...
                        {isLoading ? (
                            ...
                            <div
                                ...
                                className={`px-4 py-3 flex items-center gap-3 cursor-pointer transition-colors border-l-4 ${activeChat?.type === 'user' && activeChat.data.id === contact.id ? 'bg-blue-50 border-[#102550]' : 'border-transparent hover:bg-gray-50'}`}
                            >
                                <div className="relative">
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex justify-between items-baseline mb-0.5">
                                        <p className={`text-sm font-semibold truncate ${activeChat?.type === 'user' && activeChat.data.id === contact.id ? 'text-[#102550]' : 'text-gray-900'}`}>{contact.name}</p>
                                    </div>
                        ...
                        {filteredProjects.length === 0 ? (
                            ...
                            <div
                                ...
                                className={`px-4 py-3 flex items-center gap-3 cursor-pointer transition-colors border-l-4 ${activeChat?.type === 'project' && activeChat.data.id === project.id ? 'bg-blue-50 border-[#102550]' : 'border-transparent hover:bg-gray-50'}`}
                            >
                                <div className="relative">
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex justify-between items-baseline mb-0.5">
                                        <p className={`text-sm font-semibold truncate ${activeChat?.type === 'project' && activeChat.data.id === project.id ? 'text-[#102550]' : 'text-gray-900'}`}>{project.name}</p>
                                    </div>
                ...
                <div className={`${activeChat ? 'flex' : 'hidden md:flex'} flex-col flex-1 bg-[#F9FAFB] relative main-chat w-full`}>
                    ...
                    <div className="h-16 border-b border-gray-100 bg-white flex items-center justify-between px-4 md:px-6 shrink-0 z-10 w-full">
                        <div className="flex items-center gap-2 md:gap-3">
                            ...
                            <div className={`w-9 h-9 md:w-10 md:h-10 rounded-xl flex items-center justify-center font-bold text-lg md:text-xl ${activeChat?.type === 'project' ? 'bg-orange-100 text-[#d97706]' : 'bg-blue-100 text-[#102550]'}`}>
