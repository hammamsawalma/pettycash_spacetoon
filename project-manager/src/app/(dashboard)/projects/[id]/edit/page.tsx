                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select
                                        ...
                                        className="w-full rounded-xl border border-gray-200 p-3.5 md:p-4 outline-none focus:ring-2 focus:ring-[#7F56D9] text-xs md:text-sm shadow-sm font-medium bg-white"
                                    >
