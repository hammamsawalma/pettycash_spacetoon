...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    ({ className = "", variant = "primary", size = "default", isLoading = false, disabled, children, ...props }, ref) => {
        ...
        let variantStyles = "";
        if (variant === "primary") variantStyles = "bg-gradient-to-r from-[#102550] to-[#2563eb] text-white hover:shadow-lg hover:shadow-[#102550]/25 hover:from-[#1a3a7c] hover:to-[#102550] border border-transparent";
